...
object AesGcm {
     ...
     */
    fun encrypt(plaintext: ByteArray, key: ByteArray, nonce: ByteArray = generateNonce()): ByteArray {
    ...
    /** Base64 包装版本 */
    fun encryptToBase64(plaintext: ByteArray, key: ByteArray, nonce: ByteArray = generateNonce()): String =
        Base64.getEncoder().encodeToString(encrypt(plaintext, key, nonce))

    fun decryptFromBase64(input: String, key: ByteArray): ByteArray =
        decrypt(Base64.getDecoder().decode(input), key)
}
